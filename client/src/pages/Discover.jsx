...
export const Discover = () => {
  ...
  useEffect(() => {
    // Check if there's a mood passed in the URL from the Home page
    ...
    if (initialMood) {
      ...
      fetchMusic("top hits 2025"); // Fallback default
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white">
      ...
      <main
        className={`w-full transition-all duration-300 ease-in-out pt-16 pb-32 min-h-screen flex flex-col ${
          isCollapsed ? "md:ml-[80px]" : "md:ml-[260px]"
        }`}
      >
        <div className="w-full px-8 md:px-16 box-border">
